...
- **Errors:** `!T` for error unions, `try` propagates, `catch` handles (see Ch7 for details)
...
- **Jump to:** [Naming §3.2](#naming-conventions) | [defer §3.3](#defer-and-errdefer) | [comptime §3.5](#comptime-execution)
:::
