...
Explains when to use async vs threads and how to reason about scheduling.

## Scope
Async/await usage, event loops, std.Thread basics, profiling/benchmarking entry points.
